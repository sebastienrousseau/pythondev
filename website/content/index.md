...
<section id="features" class="section">
  <div class="container text-center">
    ...
    <p class="section-desc">A terminal-first Python 3.12+ environment with the
    ...
    <div class="ide-layout">
      ...
      <div class="ide-center">
        <div class="ide-pane ide-editor">
          ...
          <p>Editor pane loaded with Neovim and Pyright/Ruff LSP.</p>
        </div>
        <div class="ide-pane ide-terminal">
          <h3>Center-Bottom (56% W, 30% H)</h3>
          <p>Integrated bash terminal with activated virtualenv.</p>
        </div>
      </div>
