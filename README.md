...
<p align="center">
  <img src="assets/logo.svg" alt="pythondev logo" width="140" />
</p>

<h1 align="center">pythondev</h1>

<p align="center">
  Portable, hardened Python 3.12+ development container with TMUX IDE,
  Model Context Protocol (MCP) AI agent tooling, uv, ruff, mypy, pytest, mobile WebTTY, and dotfiles bootstrap.
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/pythondev/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/pythondev/ci.yml?style=for-the-badge&logo=github" alt="Build" /></a>
...
Clone this repository and spin up a complete, hardened Python terminal IDE in seconds:
...
`pythondev` is the Python member of the [`langdev`](https://github.com/sebastienrousseau/langdev) suite:
...
- **Center-Top (56% W, 70% H)**: Editor pane loaded with Neovim and Pyright/Ruff LSP.
- **Center-Bottom (56% W, 30% H)**: Integrated bash terminal with activated virtualenv.
